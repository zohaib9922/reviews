...
<div class="sfsi-footer-container">
    <div class="sfsi-footer-pointing-to-premium-plugin">
        <picture>
            <source srcset="<?php echo SFSI_PLUGURL ?>images/footer_banner/banner-top-decor@desktop.svg" media="(min-width:1200px)">
            <source srcset="<?php echo SFSI_PLUGURL ?>images/footer_banner/banner-top-decor@tablet.svg" media="(min-width:768px)">
            <source srcset="<?php echo SFSI_PLUGURL ?>images/footer_banner/banner-top-decor@mobileH.svg" media="(min-width:475px)">
            <img class="sfsi-footer-pointing-to-premium-plugin__top-decor-img" src="<?php echo SFSI_PLUGURL ?>images/footer_banner/banner-top-decor@mobile.svg" alt="" width="290" height="110" />
        </picture>
        <span class="sfsi-footer-pointing-to-premium-plugin__title">
            <?php _e( '...and much more is possible with', 'ultimate-social-media-icons' ); ?>
            <span class="sfsi-footer-pointing-to-premium-plugin__title-crown-text">
                <svg  class="sfsi-footer-pointing-to-premium-plugin__title-crown-text-icon" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="1.0647" y="12.271" width="14.916" height="3.72899" rx="0.791314" fill="#FFA800"/>
                    <path d="M7.83859 1.18288L3.35124 8.93375C3.04582 9.46129 3.42649 10.1215 4.03607 10.1215H13.0108C13.6203 10.1215 14.001 9.46129 13.6956 8.93375L9.20824 1.18288C8.90345 0.656428 8.14338 0.656428 7.83859 1.18288Z" fill="#FFA800"/>
                    <path d="M15.1298 11.7385H4.01254C3.21464 11.7385 2.91828 10.6914 3.59782 10.2732L15.6415 2.86173C16.207 2.51373 16.9238 2.97495 16.8414 3.63381L15.915 11.0453C15.8655 11.4413 15.5289 11.7385 15.1298 11.7385Z" fill="#EAB500"/>
                    <path d="M1.91612 11.7385H13.0334C13.8313 11.7385 14.1276 10.6914 13.4481 10.2732L1.40441 2.86173C0.838914 2.51373 0.122119 2.97495 0.204476 3.63381L1.13091 11.0453C1.18041 11.4413 1.51704 11.7385 1.91612 11.7385Z" fill="#F9C100"/>
                </svg>
            <?php _e( 'Premium', 'ultimate-social-media-icons' ); ?></span>
        </span>
        <div class="sfsi-footer-pointing-content clearfix">
            <div class="sfsi-footer-left-section">
                <div class="row sfsi-footer-left-section__row">
                    <div class="sfsi-equal-col-md-6">
                        <ul class="sfsi-footer-left-section__features-list">
                            <li class="sfsi-footer-left-section__features-list-item">
                                <span class="sfsi-left-image-section">
                                    <img src="<?php echo SFSI_PLUGURL ?>images/footer_banner/more_likes_shares.svg" alt="" />
                                </span>
                            ...
                            <li class="sfsi-footer-left-section__features-list-item">
                                <span class="sfsi-left-image-section">
                                    <img src="<?php echo SFSI_PLUGURL ?>images/footer_banner/more_icon_designs.svg" alt="" />
                                </span>
                                <span class="sfsi-li-right-content">
                            ...
                            <li class="sfsi-footer-left-section__features-list-item">
                                <span class="sfsi-left-image-section">
                                    <img src="<?php echo SFSI_PLUGURL ?>images/footer_banner/themed_icons.svg" alt="" />
                                </span>
                                <span class="sfsi-li-right-content">
                            ...
                            <li class="sfsi-footer-left-section__features-list-item">
                                <span class="sfsi-left-image-section">
                                    <img src="<?php echo SFSI_PLUGURL ?>images/footer_banner/better_icon_placement.svg" alt="" />
                                </span>
                                <span class="sfsi-li-right-content">
                    ...
                    <div class="sfsi-equal-col-md-6">
                        <ul class="sfsi-footer-left-section__features-list">
                            <li class="sfsi-footer-left-section__features-list-item">
                                <span class="sfsi-left-image-section">
                                    <img src="<?php echo SFSI_PLUGURL ?>images/footer_banner/mobile_optimization.svg" alt="" />
                                </span>
                                <span class="sfsi-li-right-content">
                            ...
                            <li class="sfsi-footer-left-section__features-list-item">
                                <span class="sfsi-left-image-section">
                                    <img src="<?php echo SFSI_PLUGURL ?>images/footer_banner/faster_loading.svg" alt="" />
                                </span>
                                <span class="sfsi-li-right-content">
                            ...
                            <li class="sfsi-footer-left-section__features-list-item">
                                <span class="sfsi-left-image-section">
                                    <img src="<?php echo SFSI_PLUGURL ?>images/footer_banner/friendly_support.svg" alt="" />
                                </span>
                                <span class="sfsi-li-right-content">
                            ...
                            <li class="sfsi-footer-left-section__features-list-item">
                                <span class="sfsi-left-image-section">
                                    <img src="<?php echo SFSI_PLUGURL ?>images/footer_banner/more_platforms.svg" alt="" />
                                </span>
                                <span class="sfsi-li-right-content">
            ...
            <div class="sfsi-footer-right-section">
                <span class="sfsi-right-video">
                    <div style="position:relative;padding-top:56.25%;">
                        <iframe class="sfsi-right-video__wrap" src="https://video.inchev.com/videos/embed/c952d896-34be-45bc-8142-ba14694c1bd0" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe>
                    </div>
                </span>
...
.save_export,
.optional,
.sfsi-footer-container { display: none;}
</style><?php */